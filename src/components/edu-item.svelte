...
>
	...
	<div class="pointer-events-none flex flex-1 grow-2 flex-col justify-start gap-1 p-5">
		...
		<p class="text-left text-xs font-thin text-secondary-300/80 md:text-sm">{edu.institution}</p>
		<p class="text-left text-xs font-thin text-secondary-300/80 md:text-sm">{edu.location}</p>
